...
%
\section{Éducation}
\datedexperience{Maîtrise en Génie Logiciel (M.Sc.A.)}{Janv 2023 – Présent}
...
%
\newcommand{\skillfour}{\createskill{Spoken Languages}{Français \cpshalf Anglais}}
%
\createskills{\skillfour, \skillone, \skilltwo, \skillthree}
\vspace{-3mm} % réduire l'espace blanc !

\section{Expériences \& Projets}
\datedexperience{Thèse de Maîtrise | Développement de Lever : Framework pour Éditeurs de DSLs}{Janv 2023 – Présent}
\explanation{Université McMaster | Supervision de \href{https://mosser.github.io/}{Sébastien Mosser}}{Hamilton, ON}
\explanationdetail{
	\smallskip
	\coloredbullet\ %
	Développement d'un \textit{framework} pour générer des serveurs de langages pour les langages de domaine (DSLs).

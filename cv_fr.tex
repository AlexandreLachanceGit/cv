...
\explanation{Université McMaster | Moyenne : 3,98/4,00}{Hamilton, ON}
...
\explanation{Université McMaster | Supervision par \href{https://mosser.github.io/}{Sébastien Mosser}}{Hamilton, ON}
\explanationdetail{
	\smallskip
	\coloredbullet\ %
...
%
\datedexperience{Assistant de Recherche | Développement Full-Stack}{Janv 2022 – Janv 2023}
\explanation{Université du Québec à Montréal | Supervision par \href{https://mosser.github.io/}{Sébastien Mosser}}{Montréal, QC}
\explanationdetail{
	\smallskip
	\coloredbullet\ %
...
\explanation{Université du Québec à Montréal | Supervision par \href{https://professeurs.uqam.ca/professeur/meurs.marie-jean/}{Marie-Jean Meurs}}{Montréal, QC}
\explanationdetail{
	\smallskip
	\coloredbullet\ %
...
\explanationdetail{
	...
	\smallskip
	\coloredbullet\ %
	Gestion d'une communauté en ligne de plus de 2000 étudiants, en répondant aux questions liées aux cours.
	\smallskip
}
